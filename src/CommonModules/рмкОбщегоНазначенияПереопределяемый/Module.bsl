...
Процедура ПриНачалеВыполненияРегламентногоЗадания(МетаданныеЗадания = Неопределено) Экспорт
	...
	Если Не рмкОбщегоНазначения.РазрешенаРаботаВКопииБазы() Тогда
		ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(МетаданныеЗадания);	
	КонецЕсли;	
...
Процедура ПроверитьВозможностьРаботыВКопии() Экспорт
	...
	Если Не рмкОбщегоНазначения.РазрешенаРаботаВКопииБазы() И 
				БлокировкаРаботыСВнешнимиРесурсами.РаботаСВнешнимиРесурсамиЗаблокирована() Тогда
